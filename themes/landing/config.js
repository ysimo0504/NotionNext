const CONFIG = {
  ...
  LANDING_HEADER_BUTTON_1_URL: 'https://github.com/heysimo/NotionNext',

  LANDING_HEADER_BUTTON_2_TITLE: '作者博客',
  LANDING_HEADER_BUTTON_2_URL: 'https://blog.heysimo.com/',
  ...
  LANDING_HERO_BUTTON_2_LINK: 'https://docs.heysimo.com/about',
  ...
  LANDING_POST_REDIRECT_URL:
    process.env.NEXT_PUBLIC_POST_REDIRECT_URL || 'https://blog.heysimo.com', // 重定向网站地址
  ...
  LANDING_PRICING_1_URL: 'https://docs.heysimo.com/about',
  ...
  LANDING_PRICING_2_URL:
    'https://heysimo.lemonsqueezy.com/checkout/buy/0adb9153-0799-4f51-91aa-1f06391ea4e0',
  ...
  LANDING_NEWSLETTER: process.env.NEXT_PUBLIC_THEME_LANDING_NEWSLETTER || false // 是否开启邮件订阅 请先配置mailchimp功能 https://docs.heysimo.com/article/notion-next-mailchimp
}
