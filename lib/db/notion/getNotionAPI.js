...
function getRawNotion() {
  if (!globalStore.notion) {
    globalStore.notion = new NotionLibrary({
      ...
      ofetchOptions: {
        // Override notion-client's hardcoded mode:"no-cors" which causes
        // Node.js 18+ native fetch to return opaque responses (empty body),
        // breaking all queryCollection calls.
        mode: 'cors'
      }
    })
  }
