// 注: process.env.XX是Vercel的环境变量，配置方式见：https://docs.heysimo.com/article/how-to-config-notion-next#c4768010ae7d44609b744e79e2f9959a

const BLOG = {
  // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    // process.env.NOTION_PAGE_ID || '02ab3b8678004aa69e9e415905ef32a5', // 官方模板数据库（有测试数据）
    process.env.NOTION_PAGE_ID || '8838130b7ba748c5807bdfa65233ad61',
  THEME: process.env.NEXT_PUBLIC_THEME || 'simotheme', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
